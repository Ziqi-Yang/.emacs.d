...
# python (use pylsp since it can works with venv
sudo pacman -S python-lsp-server python-mccabe python-pycodestyle python-pydocstyle python-pyflakes python-pylint python-rope autopep8 flake8 yapf python-whatthepatch
# vue
paru -S nodejs-vls
